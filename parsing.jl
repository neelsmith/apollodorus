...
# ╔═╡ b3501455-f4a6-495d-ae56-15cc6bbc9166
begin
	using PlutoUI
...
# ╔═╡ edfaec28-64a7-483a-a2e8-51f8efc890de
...
>
> - a clone of `Kanones.jl` should be in an adjacent directory
> - use the `Rebuild parser` button to recompile a parser, including any data you've added to the tables in this repository's `morphology-tables` directory
"""

# ╔═╡ 373839d1-d5fe-4118-aad5-04cc06b7d57d
md"""*Rebuild parser*: $(@bind rebuild Button("Rebuild parser"))"""

# ╔═╡ abd93791-d53e-4197-b909-aa9339468dc2
md"""*Parse string:* $(@bind str TextField(placeholder="προῖτος"))"""

# ╔═╡ 5f3faf08-96e9-49f7-ad0b-7887d83ccd3d
html"""
<br/><br/><br/><br/><br/><br/>
<br/><br/><br/><br/><br/><br/>
<br/><br/><br/><br/><br/><br/>
...
# ╔═╡ feab2e72-6582-446c-8bfb-1cbfbc134e20
md"> Text data"

# ╔═╡ db0f2c99-39a3-4d51-b423-9cce226976ce
c = begin
	textsrc = joinpath(pwd(), "texts", "apollodorus-filtered.cex")
	fromcex(textsrc, CitableTextCorpus, FileReader)
end

# ╔═╡ 21f93210-fd84-4e0f-ad7f-66caf904f24a
ortho = literaryGreek()

# ╔═╡ 87e42fad-71cf-4114-8de9-ae987fae7dac
md"> Parsing"

# ╔═╡ 574ec026-a4ca-4c15-84d5-b919d1d7053e
# ╠═╡ show_logs = false
lemmdict = lemmatadict()

# ╔═╡ 3d8a7c41-9cf6-4904-bc7b-37e412f7cf1b
"""Build parser using Kanones core data and local additions in this repo."""
function buildparser()
	rulesds = joinpath(pwd() |> dirname, "Kanones.jl", "datasets", "literarygreek-rules") 
	vocabds = joinpath(pwd() |> dirname, "Kanones.jl", "datasets", "lsj-vocab") 
	extra = joinpath(pwd() |> dirname, "Kanones.jl", "datasets", "extra") 
	localds = joinpath(pwd(), "morphology-tables")
	ds = dataset([rulesds, vocabds, extra, localds])
	stringParser(ds)
end

# ╔═╡ cdd0c0f8-a690-4ce5-9cb3-5df993e6b138
# ╠═╡ show_logs = false
p = begin
	rebuild
	buildparser()
...
# ╔═╡ f6e5ed00-0a5a-4604-a371-02ed885a1a31
md"""Built parser capable of analyzing **$(length(p.entries))** forms."""

# ╔═╡ aefe4a48-296c-4c50-832e-3bc9d063dc1a
if isempty(str)
	md""
else
...
# ╔═╡ 6628d68c-26f1-4347-9e78-018a39d9afc6
# ╠═╡ show_logs = false
analyzedlexical = parsecorpus(tokenizedcorpus(c,ortho, filterby = LexicalToken()), p)
